...
export const AuthProviderSignIn = ({ AuthProviderFunc, AuthProviderName }: AuthProviderSignInProps) => {
  return (
    <button
    ...
    >
      {AuthProviderName === 'GitHub' ? (<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <span className="text-sm">{AuthProviderName}</span>
    </button>
  )
}